<template>
    <v-container>
        ...
        <v-btn color="success" @click="playTestSound" class="mt-4">
        ...
        <!--
        <p class="mt-10">
            Do you hear music playing playing through your headphones?
        </p>
        <v-row class="pt-6 pl-3">
            <v-btn color="success" @click="success()" class="mr-4" :disabled="played == false">
                Yes <v-icon>check</v-icon>
            </v-btn>
            <v-btn color="error" @click="fail()" :disabled="played == false">
                No <v-icon>close</v-icon>
            </v-btn>
        </v-row>
        -->
    </v-container>
